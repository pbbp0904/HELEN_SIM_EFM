...
title('Simulated Upward (Z) Component of The Electric Field for A Tripole Thunderstorm')
...
title('Simulated Horizontal (X-Y) Component of The Electric Field for A Tripole Thunderstorm')
xlabel('Horizontal Distance, km')
ylabel('Vertical Distance, km')
colormap jet
a=colorbar;
...
title('Simulated Magnitude of The Electric Field for A Tripole Thunderstorm')
xlabel('Horizontal Distance, km')
ylabel('Vertical Distance, km')
colormap jet
a=colorbar;
